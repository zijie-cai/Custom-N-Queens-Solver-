...
class N_Queens_Game:
    def __init__(self):
        ...
        self.title = widgets.Label(
            ...
            layout=widgets.Layout(margin="0 0 5px 15px"),
        )
    ...
    def setup(self):
        ...
        title = VBox([self.title], layout=Layout(margin="40px 0 0 85px"))
    ...
    def onclick(self, event):
        ...
        if (
            ...
            if len(self.positions) == self.n:
                self.solution.value = '<span style="color:#769656; font-weight:bold;">Solution Found!</span>'
