...
class N_Queens_Game:
    def __init__(self):
        ...
        self.size = widgets.BoundedIntText(
            ...
            layout=widgets.Layout(width="200px", margin="20px 0 0 5px"),
        )
    ...
    def setup(self):
        ...
        user_control = VBox(
            [self.size, button_row, stats_box], layout=Layout(margin="0 0 0 50px")
        )

        # Store title into a box for shifting position
        title = VBox([self.title], layout=Layout(margin="40px 0 0 80px"))
        ...
        with self.output:
            ...
            display(
                VBox(
                    ...
                    layout=Layout(margin="-45px 0px 0 0px"),
                )
            )
