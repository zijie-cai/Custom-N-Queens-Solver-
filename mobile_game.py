...
class N_Queens_Game:
    def __init__(self):
        ...
        with plt.ioff():
            self.fig, self.ax = plt.subplots(figsize=(2.7, 3.0))
    ...
    def setup(self):
        ...
        title = VBox([self.title], layout=Layout(margin="40px 0 0 30px"))
            ...
            display(
                VBox(
                    [
                        ...
                        VBox(
                            [title, user_control],  # Put title above user control
                            layout=Layout(margin="-50px 0px 0 10px"),
                        ),
                    ],
    ...
    def onclick(self, event):
        ...
        if (
            ...
            if len(self.positions) == self.n:
                self.solution.value = "Congratulations! All Queens Placed Successfully."
